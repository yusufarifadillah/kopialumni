            ...
            <h5 class="card-title fw-semibold mb-4">Data Pegawai</h5>
                ...
                <form action="{{ route('pegawai.update', $pegawai->id) }}" method="post">
                    ...
                    <fieldset disabled>
                        ...
                        <input class="form-control form-control-solid" id="kode_pegawai_tampil" name="kode_pegawai_tampil" type="text" placeholder="Contoh: PG-001" value="{{$pegawai->kode_pegawai}}" readonly></div>
                    </fieldset>
